...
<head>
    ...
    <title>Lupa Password - PM System</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .alert-success { background: #e3f9e9; color: #1cc88a; border-left: 3px solid #1cc88a; }
...
<body>
    <div class="container">
        <div class="logo">
            ...
            <h2>Lupa Password?</h2>
            <p style="color: #888; font-size: 13px; margin-top: 5px;">Masukkan email Anda untuk reset password</p>
        </div>
        ...
        <form action="<?= base_url('forgot-password/request') ?>" method="post">
            ...
            <button type="submit" class="btn-submit" id="btnSubmit">
                <span class="btn-text">Kirim Reset Password</span>
