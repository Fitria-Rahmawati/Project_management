                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="mt-2 mb-0"><?= $totalProjects ?? 0 ?></h3>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="mt-2 mb-0"><?= $totalIssues ?? 0 ?></h3>
                            <small class="text-warning">
                                <i class="fas fa-clock me-1"></i><?= $overdueIssues ?? 0 ?> Overdue
                            </small>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="mt-2 mb-0"><?= $completedIssues ?? 0 ?></h3>
                            <small class="text-success">
                                <i class="fas fa-check-circle me-1"></i><?= $completionRate ?? 0 ?>% Complete
                            </small>
                        </div>
...
new Chart(priorityCtx, {
    ...
    data: {
        ...
        datasets: [{
            ...
            backgroundColor: ['#dc3545', '#fd7e14', '#ffc107', '#6c757d', '#adb5bd'],
            borderRadius: 5
        }]
    },
    options: {
